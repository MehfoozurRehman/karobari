...
export default function ContactPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-50 font-sans selection:bg-emerald-500 selection:text-black relative">
      ...
      <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-8 relative z-10 w-full">
        <div className="space-y-4 text-center sm:text-left">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-white pt-4">Contact Support</h1>
