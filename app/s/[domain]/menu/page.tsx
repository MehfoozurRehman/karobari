  ...
  return (
    <div className="min-h-screen bg-[#faf7f2]">
      ...
      <div className="mx-auto max-w-5xl px-4 py-10">
        <h1 className="mb-8 text-3xl font-extrabold tracking-tight text-stone-900">Full Menu</h1>
        <ItemGrid data={data} accent="#047857" />
      </div>
      <StoreFooter name={data.business.name} whatsappNumber={data.whatsappNumber} />
    </div>
  );
}
