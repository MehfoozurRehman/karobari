...
import { MessageSquare, Globe, HandCoins, Users, Percent, Sparkles, Smartphone, ArrowRight, CheckCircle2 } from 'lucide-react';

const trustBadges = ['First 20 Orders Free', 'Pay via EasyPaisa / JazzCash', 'No Technical Knowledge Required'];
  ...
  return (
    <div>
      <section className="relative overflow-hidden">
        <div aria-hidden className="pointer-events-none absolute inset-x-0 top-0 h-[480px] bg-[radial-gradient(ellipse_at_top,rgba(16,122,87,0.08),transparent_60%)]" />
        <div className="mx-auto max-w-6xl px-4 pb-20 pt-20 text-center sm:px-6 sm:pt-28">
          <Badge className="rounded-full border border-emerald-200 bg-emerald-50 px-4 py-1.5 text-xs font-semibold uppercase tracking-wide text-emerald-800">Made for Pakistani Small Businesses</Badge>
          ...
          <h1 className="mx-auto mt-8 max-w-4xl text-4xl font-extrabold leading-[1.08] tracking-tight text-stone-900 sm:text-5xl lg:text-6xl">
            Apna Karobar Online Le Kar Ayein <span className="text-emerald-700">Sirf Aik WhatsApp Message Se!</span>
          </h1>
          ...
          <div className="mx-auto mt-10 flex max-w-md flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <Link href="#pricing" className="w-full sm:w-auto">
              <Button variant="outline" className="h-13 w-full rounded-full border-stone-300 px-8 text-base font-semibold text-stone-700 hover:bg-stone-100 sm:w-auto">
                Calculate Earnings
              </Button>
            </Link>
          </div>
      ...
      <section id="whatsapp" className="scroll-mt-20 border-y border-stone-200 bg-white">
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-stretch gap-8 px-4 py-16 sm:px-6 lg:grid-cols-12">
          <div className="flex flex-col justify-between rounded-3xl border border-stone-200 bg-[#faf9f6] p-5 shadow-sm lg:col-span-5">
            <div>
              <div className="mb-4 flex items-center justify-between border-b border-stone-200 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold leading-tight text-stone-900">Karobari Assistant</h4>
                    <p className="text-[11px] text-stone-500">Official Shop Agent</p>
                  </div>
                </div>
                <Badge className="border-none bg-emerald-100 px-2 py-0.5 text-[10px] text-emerald-800">Roman Urdu Agent</Badge>
              </div>

              <div className="space-y-3 text-xs">
                <div className="flex justify-end">
                  <div className="max-w-[85%] rounded-2xl rounded-tr-sm bg-emerald-700 px-4 py-2.5 text-emerald-50 shadow-sm">
                    <p className="mb-1 text-[10px] font-semibold text-emerald-200">Customer (WhatsApp)</p>
                ...
                <div className="flex justify-start">
                  <div className="max-w-[85%] rounded-2xl rounded-tl-sm border border-stone-200 bg-white px-4 py-2.5 text-stone-700 shadow-sm">
                    <p className="mb-1 text-[10px] font-semibold text-emerald-700">Karobari AI</p>
                ...
                <div className="flex justify-start">
                  <div className="max-w-[85%] rounded-2xl rounded-tl-sm border border-stone-200 bg-white px-4 py-2.5 text-stone-700 shadow-sm">
                    <p className="mb-1 text-[10px] font-semibold text-emerald-700">Karobari AI</p>
                    <p>
                      Order #1042 confirm ho gya hai! COD select kiya gya hai. Aap is link pr check kr skte hain:{' '}
                      <span className="cursor-pointer text-emerald-700 underline">khybershinwari.karobari.shop/order/1042</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-4 border-t border-stone-200 pt-4 text-center text-[11px] text-stone-500">💬 AI acts as a 24/7 dedicated sales representative for your customers.</div>
          </div>
          ...
          <div className="relative flex flex-col justify-between overflow-hidden rounded-3xl border border-stone-200 bg-[#faf9f6] p-5 shadow-sm lg:col-span-7">
            <div className="space-y-5">
              <div className="flex items-center justify-between border-b border-stone-200 pb-4">
                <div>
                  <h4 className="text-sm font-bold text-stone-900">Dynamic Storefront Web App</h4>
                  <p className="text-xs text-stone-500">Beautiful templates generated matching your brand</p>
                </div>
              </div>
              ...
              <div className="space-y-4 rounded-2xl border border-stone-200 bg-white p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="flex h-6 w-6 items-center justify-center rounded-md bg-emerald-700 text-xs font-extrabold text-white">K</div>
                    <span className="text-xs font-bold text-stone-900">Khyber Shinwari</span>
                  </div>
                  <Badge className="border-none bg-emerald-100 text-[9px] text-emerald-800">Restaurant Theme</Badge>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={item.name} className="space-y-2 rounded-xl border border-stone-200 bg-[#faf9f6] p-3">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button className="rounded bg-emerald-700 px-2 py-0.5 text-[9px] font-bold text-white">+</button>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="flex items-center justify-between border-t border-stone-100 pt-2">
                  ...
                  <button className="rounded-lg bg-emerald-700 px-3 py-1.5 text-[10px] font-extrabold text-white">Checkout Order</button>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 flex items-center justify-between border-t border-stone-200 pt-4 text-xs text-stone-500">
              ...
              <span className="font-bold text-emerald-700">100% Mobile Responsive</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="scroll-mt-20 py-20">
        <div className="mx-auto max-w-6xl space-y-12 px-4 text-center sm:px-6">
          <div className="space-y-4">
            <Badge className="rounded-full border border-emerald-200 bg-emerald-50 font-semibold text-emerald-800">Comprehensive Capabilities</Badge>
            <h2 className="text-3xl font-extrabold tracking-tight text-stone-900 sm:text-4xl">Features Built to Deliver Credibility</h2>
            <p className="mx-auto max-w-2xl text-base text-stone-600 sm:text-lg">We provide professional tools to scale your business operations with zero tech stress.</p>
          </div>

          <div className="grid grid-cols-1 gap-6 text-left md:grid-cols-2 lg:grid-cols-3">
            {features.map((f) => (
              <div key={f.title} className="space-y-4 rounded-3xl border border-stone-200 bg-white p-7 shadow-sm transition-shadow hover:shadow-md">
      ...
      <section id="pricing" className="scroll-mt-20 border-y border-stone-200 bg-white py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
            <div className="space-y-6 lg:col-span-5">
              <Badge className="rounded-full border border-emerald-200 bg-emerald-50 font-semibold text-emerald-800">No High Upfront Cost</Badge>
              <h2 className="text-3xl font-extrabold leading-[1.1] tracking-tight text-stone-900 sm:text-4xl">Simple Pricing. Only Pay Once You Grow.</h2>
              <p className="text-base leading-relaxed text-stone-600">Forget about heavy setups or subscriptions. Karobari aligns entirely with your business success.</p>
                ...
                {[
                  ...
                  <div key={p.title} className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs leading-relaxed text-stone-500">{p.body}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section id="faq" className="scroll-mt-20 py-20">
        <div className="mx-auto max-w-6xl space-y-12 px-4 text-center sm:px-6">
          <div className="space-y-4">
            <Badge className="rounded-full border border-emerald-200 bg-emerald-50 font-semibold text-emerald-800">Frequently Asked Questions</Badge>
            <h2 className="text-3xl font-extrabold text-stone-900 sm:text-4xl">Everything You Need To Know</h2>
          </div>
      ...
      <section className="border-t border-stone-200 bg-emerald-900 py-20 text-center">
        <div className="mx-auto max-w-3xl space-y-7 px-4">
          <h2 className="text-3xl font-extrabold leading-tight text-white sm:text-4xl">Apni Online Dukaan Aaj Hi Shuru Karen!</h2>
          <p className="mx-auto max-w-xl text-base text-emerald-100 sm:text-lg">Setup your store and launch a premium storefront within 5 minutes. No credit card required.</p>
